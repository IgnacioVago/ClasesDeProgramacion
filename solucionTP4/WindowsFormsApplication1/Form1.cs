...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            string op = cmbMarcaLamparas.Text;
            ...
            switch (op)
            {
                case "ArgentinaLuz":
                    if (cantidadLamparas==5)
                    {
                        ...
                        {
                            total = total * 1.10f;
                            MessageBox.Show("Usted pago: $" + total + " de IIBB");
                        }
                        else
                        {
                            MessageBox.Show("Se compraron " + cantidadLamparas + " lamparas y tuvo un descuento del 40%, lo que le sale: $" + total);
                        }
                    }
                    else
                     {
        ...
        {
            cantidadLamparas = float.Parse(txtLamparitas.Text);
        }
    }
}
